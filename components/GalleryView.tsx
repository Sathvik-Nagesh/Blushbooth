        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
          {photos.map((photo) => (
            <button
              ...
              className="aspect-square bg-white rounded-xl p-1.5 shadow-sm hover:shadow-md transition-shadow cursor-pointer border border-rose-50 w-full"
              aria-label={`View memory from ${formatDate(photo.timestamp)}`}
            >
              <img 
